...
Constants:
  ...
  - CB_SKILL_*: Skill board selection/pagination
  ...
  - CB_PROMPT_*: Structured interactive prompt selection/pagination
...
# Skills board
CB_SKILL_SELECT = "sk:sel:"  # sk:sel:<index>
CB_SKILL_PAGE = "sk:page:"  # sk:page:<page>
CB_SKILL_CANCEL = "sk:cancel"
...
CB_ASK_PGUP = "aq:pgup:"  # aq:pgup:<window>
CB_ASK_PGDN = "aq:pgdn:"  # aq:pgdn:<window>
...
# Structured interactive prompt
CB_PROMPT_SELECT = "iap:sel:"  # iap:sel:<option_index>
CB_PROMPT_PAGE = "iap:page:"  # iap:page:<page_index>
CB_PROMPT_CANCEL = "iap:cancel"
...
# Runtime picker (choose Codex vs Claude Code)
CB_RUNTIME_CODEX = "rt:codex"
CB_RUNTIME_CLAUDE = "rt:claude"
CB_RUNTIME_CANCEL = "rt:cancel"
